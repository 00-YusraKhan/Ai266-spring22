...
Problems We face
KNN didn't work properly on the large data set and in this project we have a very large data.
Its memory intensive.
It took alot of time while training data.
Our project accuracy is not upto mark because we can not implement deep learning algorithms here.
